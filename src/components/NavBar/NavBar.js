    ...
    <div className="headerContainer">
      <div className="cantinero">
        ...
        <div>
          <div
            className="clickMoe"
            onClick={() => setShowUno(!showUno)}
            onDoubleClick={() => setShowDos(!showDos)}
          ></div>
      ...
      <nav className="navegador">
        <ul className="menu">
          <li className="option">
            <NavLink
              to="/elBardeMoe"
              className={({ isActive }) => (isActive ? "botonActivo" : "boton")}
            >
              <b>Home</b>
            </NavLink>
          </li>
          {categorys.map((cates) => (
            <li className="option" key={`${cates.id}`}>
              <NavLink
                to={`/category/${cates.id}`}
                className={({ isActive }) =>
                  isActive ? "botonActivo" : "boton"
                }
              >
                <b>{cates.label}</b>
              </NavLink>
